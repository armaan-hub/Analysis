"""
End-to-end test: generates Castle_Plaza_Audit_2025_v5.pdf
...
OUT_PDF   = BASE / "Testing data" / "Castle_Plaza_Audit_2025_v5.pdf"
OUT_JSON  = BASE / "Testing data" / "Castle_Plaza_Audit_2025_v5.json"
...
async def main():
    print("=" * 65)
    print("  Castle Plaza Audit Report v5 — Generator")
    print("=" * 65)
