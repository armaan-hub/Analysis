"""
End-to-end test: generates Castle_Plaza_Audit_2025_v6.pdf
...
OUT_PDF   = BASE / "Testing data" / "Castle_Plaza_Audit_2025_v6.pdf"
OUT_JSON  = BASE / "Testing data" / "Castle_Plaza_Audit_2025_v6.json"
...
async def main():
    print("=" * 65)
    print("  Castle Plaza Audit Report v6 — Generator")
    print("=" * 65)
