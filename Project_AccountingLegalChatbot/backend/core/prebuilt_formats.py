...
PREBUILT_FORMATS = [
    ...
    {
        "id": "prebuilt-comparative-mainland",
        "name": "Comparative Mainland Audit Report Format",
        "format_family": "IFRS",
        "format_variant": "UAE Mainland Comparative (2025/2024)",
        "description": "Standard UAE Mainland Comparative Audit Report with strict 2025/2024 chronological order, Corporate Directory, Notes 1-15 & math tie-outs",
        "config": {
            "page": {"width": 595.28, "height": 841.89, "unit": "points", "detected_size": "A4", "confidence": 1.0},
            ...
            "sections": [
                {"name": "cover", "page": 1, "layout": "static"},
                {"name": "corporate_directory", "page": 2, "layout": "flow"},
                {"name": "auditors_report", "page": 3, "layout": "flow"},
                {"name": "sofp", "page": 4, "layout": "flow"},
                {"name": "sopl", "page": 5, "layout": "flow"},
                {"name": "soce", "page": 6, "layout": "flow"},
                {"name": "cfs", "page": 7, "layout": "flow"},
                {"name": "notes", "pages": [8, 9, 10, 11, 12, 13, 14, 15], "layout": "flow"},
            ],
            "substitutions": {},
            "extraction_metadata": {
                "analyzer_version": "prebuilt",
