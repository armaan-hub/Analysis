...
DOMAIN_PROMPTS: dict[str, str] = {
    ...
    "vat": (
        ...
        "Cabinet Decision No. 52/2017, Schedule 3, and are subject to VAT at the "
        ...
        "- Portal steps: Sign up on tax.gov.ae → select **Non-Registered Persons** → "
        ...
        "Cabinet Decision No. 52/2017 Schedule 3; FTA Public Clarification VATP015.\n"
